...
Juv.IC.S <- function(maxT25, aveT20, high.pred, no.con.pts, prop.div, tot.div, strand,int,sl1,sl2,sl3,vary,pctil){
  
  B0<- int#-0.75
  b.contact<-sl1#0.0358
  b.pro.div<-sl2#0.05
  b.tot.div<-sl3#0.215
...
# Juv.IC.S(maxT25=c(0,1,0,0,0), aveT20=c(0,0,1,0,0), high.pred=c(0,0,0,1,0), 
#          no.con.pts=rep(10,5), prop.div=rep(0,5), tot.div=rep(0,5), strand=c(0,0,0,0,1))
...
Juv.FP.S <- function(maxT25, aveT20, high.pred, no.con.pts, prop.div, tot.div, strand, wks.fld=rep(2,31),int,sl1,sl2,sl3,vary,pctil){
...
#  Juv.FP.S(maxT25=c(0,1,0,0,0), aveT20=c(0,0,1,0,0), high.pred=c(0,0,0,1,0), 
#           no.con.pts=rep(10,5), prop.div=rep(0,5), tot.div=rep(0,5), strand=c(0,0,0,0,1))
...
Juv.DLT.S <- function(maxT25, aveT20, high.pred, no.con.pts, prop.div, tot.div,int,sl1,sl4,vary,pctil){
...
Juv.OUTM.S <- function(Q.cms, aveT,tot.div,prop.div,int1,int2,sl2,sl3,vary,pctil){
