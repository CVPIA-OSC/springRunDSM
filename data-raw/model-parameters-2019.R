...
params <- list(
  ...
  ..surv_juv_rear_int = c(`Upper Sacramento River` = -2.25097915, 
                          `Antelope Creek` = -2.25097915, 
                          `Battle Creek` = 2.79189516,
                          `Bear Creek` = -2.25097915, 
                          `Big Chico Creek` = -2.25097915, 
                          `Butte Creek` = -0.70866158,
                          `Clear Creek` = 	2.79189516, 
                          `Cottonwood Creek` = -2.25097915, 
                          `Cow Creek` = -2.25097915,
                          `Deer Creek` = -2.31387713, 
                          `Elder Creek` = -2.25097915, 
                          `Mill Creek` = 1.8664113,
                          `Paynes Creek` = -2.25097915, 
                          `Stony Creek` = -2.25097915, 
                          `Thomes Creek` = -2.25097915,
                          `Upper-mid Sacramento River` = -2.56726844, 
                          `Sutter Bypass` = -2.25097915,
                          `Bear River` = -2.25097915, 
                          `Feather River` = -0.5542307, 
                          `Yuba River` = -3.49999933,
                          `Lower-mid Sacramento River` = 	-2.56726844, 
                          `Yolo Bypass` = -2.25097915, 
                          `American River` = -2.25097915,
                          `Lower Sacramento River` = -2.56726844, 
                          `Calaveras River` = -2.25097915, 
                          `Cosumnes River` = -2.25097915,
                          `Mokelumne River` = -2.25097915, 
                          `Merced River` = -2.25097915, 
                          `Stanislaus River` = -2.25097915,
                          `Tuolumne River` = -2.25097915, 
                          `San Joaquin River` = 2.10420292),
