...
#' @param .sss_intercept Intercept for Sutter and Steamboat Sloughs, source: \href{https://doi.org/10.1139/cjfas-2017-0310}{This submodel is adapted from Perry et al. (2018)}
...
route_south_delta <- function(freeport_flow, dcc_closed, month,
  ...
  psi_SS <- boot::inv.logit(.sss_intercept + .sss_freeport_discharge * standardized_flow)
